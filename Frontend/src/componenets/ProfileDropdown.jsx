...
const handleSignup = async (e) => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      {/* Toaster (Global Notification Handler) */}
      ...
      {/* Dropdown Menu */}
      {dropdownOpen && (
        <div className="absolute right-0 mt-2 w-48 bg-white border shadow-lg rounded-xl overflow-hidden animate-fade-in z-50">
          {isLoggedIn ? (
            <>
              <button
                className="flex items-center gap-3 w-full text-left px-4 py-3 hover:bg-blue-50 transition-colors"
              ...
              <button
                ...
                className="flex items-center gap-3 w-full text-left px-4 py-3 hover:bg-red-50 transition-colors"
              >
            ...
            <button
              className="flex items-center gap-3 w-full text-left px-4 py-3 hover:bg-green-50 transition-colors"
              onClick={() => {
                setShowLoginModal(true);
                setDropdownOpen(false);
              }}
